...
class MultiMesh(Mesh):
    ...
    def transform(self, transformations: np.array):
...
def merge_objects(objects: list[Mesh]):
    ...
    for obj in objects:
        ...
        last_tri_index = first_vert_index + len(obj.triangle_indices)
        ...
        merged_triangle_indices[first_tri_index: last_tri_index, :] = obj.triangle_indices + first_tri_index
